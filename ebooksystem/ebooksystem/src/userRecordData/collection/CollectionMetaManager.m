...
- (BOOL)saveCollectionMeta:(CollectionMeta *)collectMeta {
    ...
    // 1. try update if exists
    {
        ...
        // Entity
        NSEntityDescription *entity = [NSEntityDescription entityForName:@"CollectionEntity" inManagedObjectContext:[CoreDataUtil instance].managedObjectContext];
    ...
    // 2. insert as new
    if (saved == NO) {
        NSManagedObject *entity = [NSEntityDescription insertNewObjectForEntityForName:@"CollectionEntity" inManagedObjectContext:[CoreDataUtil instance].managedObjectContext];
